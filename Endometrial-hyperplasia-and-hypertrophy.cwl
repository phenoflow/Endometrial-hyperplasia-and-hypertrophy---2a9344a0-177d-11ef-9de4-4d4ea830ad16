...
steps:
  read-potential-cases-fhir:
    ...
    in:
      inputModule:
        id: inputModule
        source: inputModule1
  adenomatous-endometrial-hyperplasia-and-hypertrophy---primary:
    run: adenomatous-endometrial-hyperplasia-and-hypertrophy---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  endometrial-hyperplasia-and-hypertrophy-uterus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: adenomatous-endometrial-hyperplasia-and-hypertrophy---primary/output
